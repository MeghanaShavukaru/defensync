...
async function main() {
    ...
    const passwordHashCommander = await bcrypt_1.default.hash('Commander@123', 10);
    const passwordHashLogistics = await bcrypt_1.default.hash('Logistics@123', 10);
    const passwordHashAuditor = await bcrypt_1.default.hash('Auditor@123', 10);
